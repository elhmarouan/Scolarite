...
color: #1D5CBC; /* couleur des liens quand il y a le surlignage. On garde la même couleur que quand y a pas de surlignage. */
   ...
   <body>
      <center>Choisissez la promo à modifier</center>
      <center><ul id="menu">
         <li><a href="http://scolarite.fr.nf/prof/ajouterNotes/cpi1/modules">CPI 1</a></li>
         <li><a href="http://scolarite.fr.nf/prof/ajouterNotes/cpi2/modules">CPI 2</a></li>
      </ul></center>
   </body>
</html>